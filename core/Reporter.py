#!/usr/bin/env python3
"""
OWASP Top 10 Scanner - Report Generator
Creates human-readable reports from vulnerability scan results.
"""
...
class Reporter:
    ...
    def generate_report(self, vulnerabilities):
        ...
        Supports both TXT and HTML output based on file extension
        """
    ...
    def _generate_html_report(self, vulnerabilities):
        """Generate an HTML formatted vulnerability report"""
        with open(self.output_file, 'w') as f:
...
""")
    ...
    def _generate_clean_report(self):
        """Generate a report when no vulnerabilities are found"""
        if self.output_file.endswith('.html'):
